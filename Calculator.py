...
def clic(data):
    ...
    entry_equation.insert(text_position, data)
...
def solve():
    ...
    # Si la entrada de Texto esta vacia marcar error | If the Text entry is empty mark error
